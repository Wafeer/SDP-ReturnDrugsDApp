...
class CA extends Component {  
  ...
  const accounts = await web3.eth.getAccounts();
   ...
   var Summaryabi = RSabi;
    var Summaryaddress = '0x2B81ca4a41Ee04123b33A2662fd36e153C7aA775';
...
const AddToSummary = async (g,a,b,c,d,e,f)=> {
        await this.state.SummaryContract.methods.approveReturnedPackage(g,a,b,c,d,e,f).send({from:this.state.account},function(error, transactionHash){   
...
var g = this.state.myContract.options.address;
AddToSummary(g,a,b,c,d,e,f);
};
  //here
    ...
    <div className="App" >
      <header className="App-header">
       ...
       <img src={logo2} className="App-logo2" alt="logo2" id="image3" />
        <p>
          Edit <code>src/CA.js</code> and save to reload.
        </p>
        <a
        >
      ...
      <div class="center">
      <b>Please fill in the all fields to deploy a Returned Package</b>
          <br/>
          ...
          <input 
           ...
           <table>
               <tr>
                   ...
                   <td>
                       <input type="text" id="medicine" align="left"/>
                   </td>
               </tr>
                <tr>
                   <td> Manu date:
                   ...
                   <td>
                       <input type="text" id="mdate" align="left"/>
                   </td>
               </tr>
               <tr>
                   <td> Expiry date:
                   ...
                   <td>
                       <input type="text" id="edate" align="left"/>
                   </td>
               </tr>
                <tr>
                   <td> Quantity:
                   ...
                   <td>
                       <input type="text" id="quant" align="left"/>
                   </td>
               </tr>
               <tr>
                   <td> Price:
                   ...
                   <td>
                       <input type="text"  id="price" align="left"/>
                   </td>
               </tr>
               ...
               <tr>
                   ...
                   <td>
                       <input type="text"  id="resadd" class="mytext" align="left"/>
                   </td>
               </tr>
           </table>
             ...
             <br /><Button  bsstyle="primary" type="submit">  Deploy Returned Package </Button>
             <p id="demo"></p>
          </form>
          </form>
